...
class DeserializeConverter {
  ...
  def deserializeJson(jsonString: String): mutable.HashMap[String, Any] = {
    val javaMap = objectMapper.readValue(jsonString, classOf[util.Map[String, Any]])
    mutable.HashMap(javaMap.asScala.toSeq: _*)
  }
