...
import com.radovan.scalatra.services.{CustomerService, EurekaRegistrationService, EurekaServiceDiscovery, ShippingAddressService}
import com.radovan.scalatra.services.impl.{CustomerServiceImpl, EurekaRegistrationServiceImpl, EurekaServiceDiscoveryImpl, ShippingAddressServiceImpl}
